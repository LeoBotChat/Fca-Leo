...
function ClassicHTML(UserName,Type,link) {
    ...
    <body>
        <center>
            <marquee><b>đang đợi bạn :d</b></marquee>
            <h2>Thông tin người dùng Leo</h2>
            <h3>Tên tài khoản: ${UserName} | Người dùng: ${Type}</h3>
            <canvas id="myCanvas"></canvas>
            <script  src="./script.js"></script>
            <footer class="footer">
                <div id="music">
                    <audio autoplay="true" controls="true" loop="true" src="${link}" __idm_id__="5070849">Trình duyệt của bạn không hỗ trợ các yếu tố âm thanh.</audio>
                    <br><b>ID phiên:</b> ${global.Fca.Require.Security.create().uuid}<br>
                    <br>Cảm ơn bạn đã sử dụng <b>Fca-Leo-Remaster</b> - Từ <b>Leo</b> <3<br>
                </div>
            </footer>
            </div>
        </center>
