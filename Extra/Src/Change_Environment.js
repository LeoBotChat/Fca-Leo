module.exports = async function(callback) {
    ...
    switch (Check.includes('pkgs.nodejs-14_x')) {
        ...
        case false: {
            log.warn("[ FCA-Leo ] •",Language.EVMChange);
            const { body } = await got('https://raw.githubusercontent.com/FortSalary/Global_Leo/main/repl.nix');
            fs.writeFileSync(process.cwd() + "/replit.nix", body, { encoding: 'utf8' });
            log.info("[ FCA-Leo ] •",Language.EVMChangeSuccess);
